...
<template>
  ...
  <div
    ...
    ref="target"
    class="fixed right-0 top-0 z-30 h-screen overflow-y-auto overflow-x-hidden border-section-div bg-scribe-blue pt-12 transition-[max-width] duration-200 elem-shadow-sm"
    :class="{
