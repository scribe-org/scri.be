...
<template>
  <aside
    ...
    role="menu"
    tabindex="0"
    class="elem-shadow-sm focus-brand absolute z-40 block h-full flex-col border-r border-section-div bg-scribe-blue-lighter transition-all duration-500 dark:bg-scribe-blue-darker md:flex"
    :class="{
