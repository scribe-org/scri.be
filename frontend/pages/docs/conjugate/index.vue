...
const cards: DocsEntry[] = [
  {
    id: 0,
    url: "learn-more",
    title: "i18n._global.learn_more",
    description: "i18n.pages.docs.conjugate.index.conjugate_page_description",
  ...
  // {
  //   id: 1,
  //   url: "android-changelog",
  //   title: "i18n._global.android_changelog",
  //   description: "i18n.pages.docs.conjugate.index.conjugate_android_changelog",
  ...
  //   id: 2,
  //   url: "ios-changelog",
  //   title: "i18n._global.ios_changelog",
  //   description: "i18n.pages.docs.conjugate.index.conjugate_ios_changelog",
  //   iconURL: IconMap.CHANGELOG,
  //   iconSize: "3em",
  //   imgAltText: "i18n.pages.docs._global.changelog.file_code_img_alt_text",
  // },
