...
const cards: DocsEntry[] = [
  {
    ...
    description: "i18n.pages.docs.server.index.server_page_description",
  ...
  },
  {
    ...
    description: "i18n.pages.docs.server.index.available_data",
  ...
  },
  {
    ...
    description: "i18n.pages.docs.server.index.server_changelog",
